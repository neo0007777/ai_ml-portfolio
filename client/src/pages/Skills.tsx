...
export default function Skills() {
  // Programming core items (Python, SQL, Git)
  const programmingLanguages = [
    {
      ...
      description: "My primary language for algorithm design, data structures, machine learning pipelines, and backend automation.",
      projects: ["RAG Chatbot", "LSTM Forecaster", "Sentiment Analysis Engine"]
    },
    {
      name: "SQL",
      icon: Database,
  ...
  // AI & ML sub-categories (Machine Learning, Deep Learning, Generative AI)
  const aiCategories = [
    {
    ...
    },
    {
      ...
      items: [
        ...
        { name: "CNNs", status: "Experienced in", note: "Spatial feature extraction & neural classification" },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-orange-500/30 selection:text-orange-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {programmingLanguages.map((lang, idx) => (
              <motion.div
                ...
                className="bg-white/[0.03] border border-white/10 hover:border-white/20 rounded-xl p-7 transition-all hover:bg-white/[0.05] flex flex-col justify-between"
              >
                <div>
                ...
                <div className="pt-4 border-t border-white/5">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {lang.projects.map((proj, pIdx) => (
                      <span key={pIdx} className="text-xs text-foreground/70 bg-white/5 px-2 py-0.5 rounded border border-white/5 font-mono">
                        {proj}
                      </span>
                    ))}
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {aiCategories.map((cat, idx) => (
              <motion.div
                ...
                className="bg-white/[0.03] border border-white/10 rounded-2xl p-8 hover:border-white/20 transition-all flex flex-col justify-between"
              >
                <div>
                  ...
                  <div className="space-y-3">
                    {cat.items.map((item, iIdx) => (
                      <div 
                        key={iIdx}
                        className="p-3.5 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] transition-colors"
                      >
                        ...
                        <p className="text-xs text-foreground/60 font-light">{item.note}</p>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="p-8 md:p-10">
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                ...
                <div className="md:col-span-5 bg-white/5 border border-white/10 rounded-xl p-8 text-center">
                  ...
                  <span className="inline-block mt-2 px-3 py-1 bg-orange-500/10 text-orange-400 border border-orange-500/20 text-xs font-mono rounded-full font-semibold">
                    Codeforces: Pupil
                  </span>
                </div>
                ...
                <div className="md:col-span-7 space-y-4 font-mono text-sm">
                  {[
                    ...
                    { label: "Data Structures", value: "Trees, Heaps, Hash Maps, Trie" },
      ...
      {/* SECTION 4: HACKATHON ACHIEVEMENTS */}
      <section className="py-28 border-b border-white/10">
        <div className="container max-w-5xl">
          <div className="mb-16">
            <span className="text-orange-500 font-medium text-xs tracking-widest uppercase mb-2 block">
            ...
            {hackathons.map((hackathon, idx) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-foreground/70 leading-relaxed mb-6 font-light">
                    {hackathon.desc}
                  </p>
                </div>
